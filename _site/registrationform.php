<?php
$my_email = "registration@icnfa.com";
$errors = array();
...
If you are an author, please make sure to send us your final version (.doc or .docx format) and a signed copyright form via email to info@icnfa.com. You can find the copyright form here: https://icnfa.com/papers. Please note that failing to do so may result in an unsuccessful process of your registration.

You can find your registration details below. If there are any errors in the information you have provided, please write an email to us at registration@icnfa.com mentioning the correct information. Please note that you SHOULD NOT refill the form.

We are pleased to announce that the ICNFA 2019 be held at the Hotel Real Palácio. Additionally, we have collaborated with the hotel to offer our attendees a reduced 
rate on their accommodations! This discounted rate is only valid until May 12, 2019. Please view the booking form here: https://icnfa.com/RealPalacioLisbonBookingForm.pdf
    ...
    <div class="unit unit-s-3-4 unit-m-1-3 unit-l-1-3">
      ...
      <div class="unit unit-s-1-3 unit-m-2-3 unit-m-2-3-1 unit-l-2-3">
        ...
        <div class="bg">
          ...
          <p class="subhead">August 18 - 20, 2019 | Lisbon, Portugal</p>
...
<footer id="contact">
  ...
  <center class="full right cf"><div class="g-recaptcha" data-sitekey="6Le_S_8SAAAAAEjEo2aQw76o0uUjtW2o-QFzBTB9"></div></center>
  <div class="cf">
